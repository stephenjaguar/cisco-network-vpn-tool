...
| Packet Tracer or GNS3 simulation path | Complete as documentation | `simulation/PACKET_TRACER_GNS3_TESTING.md`, `simulation/`, and `PART1_FLASK_GNS3_SETUP.md` document Packet Tracer and GNS3 SSH flow |
